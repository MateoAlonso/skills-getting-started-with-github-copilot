...
activities = {
    ...
    "Basketball Team": {
        "description": "Inter-school basketball practices and games",
    ...
    "Drama Club": {
        ...
        "max_participants": 25,
        "participants": ["sophia.lee@mergington.edu", "ethan@mergington.edu"]
    },
    "Science Club": {
    ...
    "Debate Team": {
        "description": "Develop public speaking, critical thinking, and competitive debating skills",
